...
Model:
korisnik, predmet, svrhaPotvrde, zahtjevZaPotvrdu, uloga, ispit, ispit_rezultati
...
db.js ima definisane veze za:
	...
	ispit:ispit_rezultati (1:n), odn. ispit ima više rezultata
	korisnik:uloga (1:1), odn. korisnik ima jednu i samo jednu ulogu.
